...
enum ts_symbol_identifiers {
  ...
  anon_sym_let = 41,
  anon_sym_mut = 42,
  anon_sym_subscript = 43,
  anon_sym_extend = 44,
  anon_sym_Self = 45,
  anon_sym_Type = 46,
  anon_sym_self = 47,
  anon_sym_type = 48,
  anon_sym_implicit = 49,
  anon_sym_init = 50,
  anon_sym_deinit = 51,
  anon_sym_where = 52,
  anon_sym_fun = 53,
  anon_sym_pub = 54,
  anon_sym_enum = 55,
  anon_sym_category = 56,
  anon_sym_class = 57,
  anon_sym_struct = 58,
  anon_sym_operator = 59,
  anon_sym_infix = 60,
  anon_sym_prefix = 61,
  anon_sym_postfix = 62,
  anon_sym_match = 63,
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (lookahead == '_' ||
          ('h' <= lookahead && lookahead <= 'z')) ADVANCE(262);
    ...
    case 263:
      ...
      if (set_contains(sym_operator_character_set_1, 9, lookahead)) ADVANCE(264);
      END_STATE();
    case 264:
      ACCEPT_TOKEN(sym_operator);
      if (set_contains(sym_operator_character_set_1, 9, lookahead)) ADVANCE(264);
